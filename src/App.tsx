          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-2xl sm:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-indigo-600">
                  Dzidza
                </h1>
              </div>
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <main className="relative z-10">
          <motion.div
            ...
            className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-4 sm:p-6 border border-violet-100"
          >
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex flex-col justify-center">
                ...
                >
                  <button className="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
                    Start Learning
                  </button>
                  <button className="w-full sm:w-auto px-6 py-3 border border-violet-200 text-violet-600 font-medium rounded-lg hover:bg-violet-50 transition-all">
                    Explore Resources
                  </button>
                </motion.div>
              </div>
              ...
              <motion.div
                ...
                transition={{ duration: 0.5, delay: 0.5 }}
                className="bg-white rounded-xl shadow-md p-4 sm:p-5 border border-violet-100"
              >
                <TranslationForm />
              </motion.div>
            </div>
